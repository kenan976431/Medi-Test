...
from tensorflow._api.v1.keras.layers import Conv2D, Input
...
def SourceModel(shape):
    ...
    if FORMAT == "NCHW":
        y = Conv2D(filters=32, kernel_size=(5, 5), data_format="channels_first")(x)
    elif FORMAT == "NHWC":
        y = Conv2D(filters=32, kernel_size=(5, 5), data_format="channels_last")(x)
    return Model(x, y)
