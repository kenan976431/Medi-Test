...
def FollowModel_1(source_model):
    ...
    follow_model = BatchNorm2d(num_features=source_model.num_features,
                               ...
                               gamma_init=source_model.parameters_dict()["gamma"].value(),
                               beta_init=source_model.parameters_dict()["beta"].value(),
                               moving_mean_init=source_model.parameters_dict()['mean'].value(),
...
def FollowModel_2(source_model):
    ...
    follow_model = BatchNorm2d(num_features=source_model.num_features,
                               ...
                               gamma_init=source_model.parameters_dict()["gamma"].value(),
                               beta_init=source_model.parameters_dict()["beta"].value(),
                               moving_mean_init=source_model.parameters_dict()['mean'].value() + Tensor(delta),
                               moving_var_init=source_model.parameters_dict()["variance"].value(),
                               data_format=source_model.format)
    return follow_model, delta
...
def FollowModel_3(source_model):
    ...
    follow_model = BatchNorm2d(num_features=source_model.num_features,
                               eps=source_model.eps,
                               gamma_init=source_model.parameters_dict()["gamma"].value(),
                               beta_init=source_model.parameters_dict()["beta"].value() + Tensor(delta),
                               moving_mean_init=source_model.parameters_dict()['mean'].value(),
                               moving_var_init=source_model.parameters_dict()["variance"].value(),
                               data_format=source_model.format)
    return follow_model, delta
...
def FollowModel_4(source_model):
    ...
    follow_model = BatchNorm2d(num_features=source_model.num_features,
                               eps=source_model.eps,
                               gamma_init=source_model.parameters_dict()["gamma"].value() * delta,
                               beta_init=source_model.parameters_dict()["beta"].value(),
                               moving_mean_init=source_model.parameters_dict()['mean'].value(),
                               moving_var_init=source_model.parameters_dict()["variance"].value(),
                               data_format=source_model.format)
